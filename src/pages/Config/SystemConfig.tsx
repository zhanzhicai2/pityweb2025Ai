...
const SystemConfig: React.FC<SystemConfigProps> = ({ dispatch, gconfig, loading }) => {
  ...
  return (
    <PageContainer title="系统设置" breadcrumb={undefined}>
      <Spin
        spinning={
          loading.effects['gconfig/updateConfiguration'] ||
          loading.effects['gconfig/fetchSystemConfig']
        }
      >
        <Card>
          <Row>
...
export default connect(({ gconfig, loading }: any) => ({ gconfig, loading }))(SystemConfig);

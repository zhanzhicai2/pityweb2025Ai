...
class Environment extends Component<any, EnvironmentState> {
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        render: (_: any, record: any) => (
          <UserLink user={this.state.users[record.create_user.toString()]} />
        ),
      },
      {
        title: '更新时间',
    ...
    return (
      <PageContainer title="环境配置" breadcrumb={undefined}>

...
const ConstructorModal: React.FC<ConstructorModalProps> = ({
  modal,
  form,
  setModal,
  caseId,
  ...
  const getConstructorJson = (values: any) => {
...
export default connect(({ construct, testcase, loading }: any) => ({
  construct,
  loading,
  testcase,
}))(ConstructorModal);

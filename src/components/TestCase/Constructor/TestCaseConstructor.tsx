...
interface TestCaseConstructorProps {
  data: any;
  form: any;
  dispatch: any;
  testcaseData: any[];
...
const TestCaseConstructor: React.FC<TestCaseConstructorProps> = ({
  data,
  form,
  dispatch,
  testcaseData,
  ...
  const fields = [
    ...
    },
    {
      name: 'public',
      label: (
        <Tooltip title="开启共享后, 其他人可使用你的数据构造器">
          <span>
            共享
            <QuestionOutlined />
          </span>
  ...
  return <CommonForm fields={fields} left={4} right={20} record={data} pForm={form} />;
};

export default TestCaseConstructor;
